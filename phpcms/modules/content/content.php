...
class content extends admin {
    ...
    public function add() {
        if(isset($_POST['dosubmit']) || isset($_POST['dosubmit_continue'])) {
            ...
            $category = $this->categorys[$catid];
            /*if(mb_substr($category['parentdir'] , 0 , 4)=='001_'){
            ...
            if( isset ( $forminfos["base"]["keywords"]))
            {
                $forminfos["base"]["keywords"]["form"].='<input value="提取" type="button" name="close" onclick="getKey()" class="cu" style="width:60px; height:30px;">&nbsp;&nbsp;<input value="清除" type="button" name="close" onclick="clearKey()" class="cu" style="width:60px; height:30px;">';

            }
                //$formValidator = $content_form->formValidator;
                if( isset ( $forminfos["base"]["glgg"]))
                {
                    $forminfos["base"]["glgg"]["form"].='<input value="提取" type="button" name="close" onclick="getStockCode()" class="cu" style="width:60px; height:30px;">&nbsp;&nbsp;<input value="清除" type="button" name="close" onclick="clearStockCodes()" class="cu" style="width:60px; height:30px;">';
    ...
    */
    ...
    public function review() {
        //file_put_contents("/home/wwwroot/default/bolanadmin/admindev/phpcms/modules/content/1.txt",1);
        if(isset($_GET['dosubmit'])) {
            $catid = intval($_GET['catid']);
            if(!$catid) showmessage(L('missing_part_parameters'));
            $modelid = $this->categorys[$catid]['modelid'];

    ...
    <form name="myform" id="myform" action="" method="post" >
        <div class="table-list">
                ...
                if(is_array($datas)) {
                    ...
                    foreach ($datas as $r) {
                        ...
                        <tr>
                           ...
                           <td><div style=" width:100px; word-wrap: break-word; word-break: normal; "><?php echo $r['glgg'];?> </div></td>
                            <td><div style="width:150px; word-wrap: break-word; word-break: normal; "><?php echo $r['keywords'];?></div></td>
            ...
            <div class="btn"><label for="check_box"><?php echo L('selected_all');?>/<?php echo L('cancel');?></label>
				...
				<?php  if($isShowReview){?>
                <input type="button" class="button" value="批量审核" onclick="myform.action='?m=content&c=content&a=review&dosubmit=1&catid=<?php echo $catid;?>&steps=<?php echo $steps;?>';return confirm_review()"/>
                <?php }?>
...
<script type="text/javascript">
	...
	function confirm_review(){
        if(confirm('<?php echo L('confirm_review', array('message' => L('selected')));?>')) $('#myform').submit();
    }

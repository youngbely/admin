    ...
    <tbody>
		...
		<div class="explain-col">
				<select name="field">
					...
					<option value='description' <?php if($_GET['field']=='description') echo 'selected';?>>摘要</option>
				...
				<input name="keywords" type="text" value="<?php echo stripslashes($_GET['keywords'])?>" style="width:300px;" class="input-text" />
...
<div class="table-list">
	...
	<tr onclick="select_list(this,'<?php echo safe_replace($r['title']);?>',<?php echo $r['id'];?>)" class="cu" title="<?php echo L('click_to_select');?>">
        ...
        <td align='left' ><?php echo $r['catnames'];?></td>

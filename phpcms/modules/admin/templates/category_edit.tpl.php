...
<table width="100%" >
		<tr>
        <th width="200" style="display:none;"><?php echo L('role_private')?>：</th>
        <td>
		...
		<tr style="display:none;" style="display:none;"><td colspan=2><hr style="border:1px dotted #F2F2F2;"></td>
		</tr>
	  ...
	  <tr style="display:none;">
	   <th width="200" style="display:none;"><?php echo L('apply_to_child');?></th>

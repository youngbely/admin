...
<div style="background-color: #7a7a7a;margin-top: 105px;padding: 10px 0" >
    ...
    <div class="main">
        ...
        <div class="item" >
            <div class="cat">
                <img style="float: left" src="<?php echo $rk_assets_url; ?>images/catbg01.gif">
                <div style="float: left;background-color: #e8351a;padding: 0px 3px"><?php echo $key;?></div>
                <img style="float: left" src="<?php echo $rk_assets_url; ?>images/catbg02.gif">
                <div style="clear: both"></div>
            </div>
            ...
            <div class="article" style="padding-bottom:10px;">
                ...
                <div class="yjy">【研究员】：<?php echo $r["yjy"] ?></div>
                <div class="box"><p><?php echo $r["description"]; ?></p></div>

                <!--summary -->
                <!--<div class="summary" id="summary<?php echo $r['id']; ?>">
                    <?php if($r["thumb"]) {?>
                    <img src="<?php echo $r['thumb']?>" style="float:left; margin-right: 10px; width: 280px; height:200px;" />
                    <?php }?>
                    <p><?php echo $r["description"] ?></p>
                </div>
                <div style="clear: both;"></div>
                <div  id="warp<?php echo $r['id']; ?>" style=" height: 40px; line-height: 40px; float: right; margin-right: 20px; margin-top: 10px;">
                    <div id="loading<?php echo $r['id']; ?>" style="display:none;" >
                        <img src="<?php echo $rk_assets_url; ?>images/loading.gif" />数据加载中，请稍候....
                    </div>
                    <div id="cc<?php echo $r['id']; ?>" >
                        <a href="javascript:getContent('<?php echo $r['id']; ?>')" ><img style="vertical-align:middle;" src="<?php echo $rk_assets_url; ?>images/zk.png" />&nbsp;<span style="vertical-align:middle;color:#09F; font-family:'宋体'">展开文章</span></a>
                    </div>
                </div>
                <div style="clear: both;"></div>-->
...
<div id="bdshare" style="right: 0px; top: 200px; position: fixed; height: 480px; overflow: hidden;">
    <img src="<?php echo $rk_assets_url; ?>images/dir.gif" alt="" style="float:left;margin-top:150px;" onClick="showOrCloseDir()">
    <div id="bdshare_l" style="display: none; float:left;">
        <?php foreach($data["rkres"] as $key=>$val){ ?>
        <h3 style="font-family:宋体;font-size: 14px;color: #a3a3a3;padding-left: 0">【<?php echo $key;?>】</h3>
        <ul>
            <?php foreach($val as $r){?>
            <li style="font-family:宋体;font-size: 14px;line-height: 24px"><a style="color: #707070" href="#anchor<?php echo $r['id']; ?>" ><span style="margin-right: 10px">◆</span><?php echo $r["title"] ?></a></li>
            <?php }?>
        </ul>
        <div class="line-gray" style="margin: 10px auto"></div>
        <?php }?>
    </div>
    <div style="clear:both;"></div>
</div>
